class SpreeSmsruConfiguration < Configuration
...
# судя по количеству данных, предоставляемых админкой, есть ещё много чего, что 
# можно высылать продавцу. Вопрос — нужно ли?
end
